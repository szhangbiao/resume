...
const getCurerntIcon = () => themeButton.classList.contains(iconTheme) ? 'box-moon' : 'bx-sun'
...
themeButton.addEventListener('click', () => {
    ...
    localStorage.setItem('selected-icon', getCurerntIcon())
})
...
var opt = {
    margin: 0,
    filename: '时章标 Android高级工程师 简历.pdf',
